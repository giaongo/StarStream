...
from ..controllers.videoController  import retrieve_url_to_local_file
...
async def process_video_info(video_info: VideoInfo):
    try:
        ...
        video_file_path, vtt_file_path = retrieve_url_to_local_file(
        ...
        raise HTTPException(status_code=400, detail="Error processing video info")
